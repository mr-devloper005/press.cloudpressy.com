...
const inputClass = 'h-[3.4rem] rounded-[1rem] border border-[#d5dded] bg-white px-4 text-base font-bold text-[#1f2551] outline-none transition placeholder:text-[#1f2551]/35 focus:border-[#3d63ff]'
const buttonClass = 'inline-flex h-[3.4rem] items-center justify-center rounded-[1rem] bg-[#3d63ff] px-6 text-sm font-black text-white shadow-[0_18px_36px_rgba(61,99,255,0.22)] transition hover:bg-[#4b70ff] disabled:opacity-60'
